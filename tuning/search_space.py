...
from neuralforecast.models.bs_preforcast_catalog import (
    BS_PREFORCAST_STAGE_ONLY_PARAM_REGISTRY as _BS_PREFORCAST_STAGE_ONLY_PARAM_REGISTRY,
    SUPPORTED_BS_PREFORCAST_MODELS as _SUPPORTED_BS_PREFORCAST_MODELS,
)

BS_PREFORCAST_STAGE_ONLY_PARAM_REGISTRY = _BS_PREFORCAST_STAGE_ONLY_PARAM_REGISTRY
SUPPORTED_BS_PREFORCAST_MODELS = _SUPPORTED_BS_PREFORCAST_MODELS
