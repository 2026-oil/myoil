...
aaforecast 적용 안 된 informer와 

gru baseline yaml/experiment/feature_set_aaforecast/brentoil-case1-baseline.yaml

aaforecast 적용 안 된 informer와 gru 실험 
...
위 4개를 비교해서 
전체적인 성능 (mape, nrmse 및 마지막 fold 예측 4개 포인트에 대한 오차범위)
...
uv run main.py --config yaml/experiment/feature_set_aaforecast/brentoil-case1-parity-gru.yaml 이런식으로 매 iter마다 실험 비교 진행하면서 진행할 것. 
...
- 절대로 이전 실험 작성 내용 덮어쓰기하지 말고 새로운 실험은 새로 행 만들어서 진행할 것.
