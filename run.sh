...
if [[ -n "${NF_CASE_CONFIGS:-}" ]]; then
  ...
  configs=(
    "yaml/feature_set_res_level_lag_exg_xgb/brentoil-case1.yaml"
    "yaml/feature_set_res_level_lag_exg_xgb/brentoil-case2.yaml"
    "yaml/feature_set_res_level_lag_exg_xgb/brentoil-case3.yaml"
    "yaml/feature_set_res_level_lag_exg_xgb/brentoil-case4.yaml"
    "yaml/feature_set_res_level_lag_exg_xgb/wti-case1.yaml"
    "yaml/feature_set_res_level_lag_exg_xgb/wti-case2.yaml"
    "yaml/feature_set_res_level_lag_exg_xgb/wti-case3.yaml"
    "yaml/feature_set_res_level_lag_exg_xgb/wti-case4.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/brentoil-case1.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/brentoil-case2.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/brentoil-case3.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/brentoil-case4.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/wti-case1.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/wti-case2.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/wti-case3.yaml"
    "yaml/feature_set_res_level_lag_exg_lgbm/wti-case4.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/brentoil-case1.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/brentoil-case2.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/brentoil-case3.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/brentoil-case4.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/wti-case1.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/wti-case2.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/wti-case3.yaml"
    "yaml/feature_set_res_delta_lag_exg_xgb/wti-case4.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/brentoil-case1.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/brentoil-case2.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/brentoil-case3.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/brentoil-case4.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/wti-case1.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/wti-case2.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/wti-case3.yaml"
    "yaml/feature_set_res_delta_lag_exg_lgbm/wti-case4.yaml"
  )
fi
