...
class InformerHorizonAwareHead(nn.Module):
    ...
    def forward(
        ...
        prototype_transport_gate = (0.5 * family_gate) + (0.5 * memory_confidence.unsqueeze(1))
        prototype_component = (prototype_level + prototype_curve) * prototype_transport_gate
